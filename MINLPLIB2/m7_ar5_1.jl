...
-0.119523*x58-0.597614*x60<=-2,  #= e48: =#
-0.5*x59-0.2*x61<=-2,  #= e49: =#
-0.141421*x59-0.70711*x61<=-2,  #= e50: =#
-0.555556*x62-0.2*x64<=-2,  #= e51: =#
-0.149071*x62-0.745356*x64<=-2,  #= e52: =#
-0.833333*x66-0.2*x68<=-2,  #= e53: =#
-0.182575*x66-0.912867*x68<=-2,  #= e54: =#
-0.5*x70-0.2*x72<=-2,  #= e55: =#
-0.141421*x70-0.70711*x72<=-2,  #= e56: =#
-0.2*x74-0.2*x76<=-2,  #= e57: =#
-0.089443*x74-0.447212*x76<=-2,  #= e58: =#
-0.2*x78-0.2*x80<=-2,  #= e59: =#
-0.089443*x78-0.447212*x80<=-2,  #= e60: =#
x54+0.5*x58<=20,  #= e61: =#
-x54+0.5*x58<=0,  #= e62: =#
x57+0.5*x60<=5,  #= e63: =#
-x57+0.5*x60<=0,  #= e64: =#
