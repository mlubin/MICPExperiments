...
-0.188982*x58-0.377964*x60<=-2,  #= e48: =#
-0.447207*x59-0.22361*x61<=-2,  #= e49: =#
-0.223609*x59-0.44721*x61<=-2,  #= e50: =#
-0.471409*x62-0.2357*x64<=-2,  #= e51: =#
-0.235705*x62-0.4714*x64<=-2,  #= e52: =#
-0.577334*x66-0.288683*x68<=-2,  #= e53: =#
-0.288675*x66-0.57735*x68<=-2,  #= e54: =#
-0.447207*x70-0.22361*x72<=-2,  #= e55: =#
-0.223609*x70-0.44721*x72<=-2,  #= e56: =#
-0.2*x74-0.2*x76<=-2,  #= e57: =#
-0.141421*x74-0.282844*x76<=-2,  #= e58: =#
-0.2*x78-0.2*x80<=-2,  #= e59: =#
-0.141421*x78-0.282844*x80<=-2,  #= e60: =#
x54+0.5*x58<=20,  #= e61: =#
-x54+0.5*x58<=0,  #= e62: =#
x57+0.5*x60<=5,  #= e63: =#
-x57+0.5*x60<=0,  #= e64: =#
