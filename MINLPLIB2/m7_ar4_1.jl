...
-0.133631*x58-0.534521*x60<=-2,  #= e48: =#
-0.5*x59-0.2*x61<=-2,  #= e49: =#
-0.158113*x59-0.63246*x61<=-2,  #= e50: =#
-0.555556*x62-0.2*x64<=-2,  #= e51: =#
-0.166667*x62-0.666667*x64<=-2,  #= e52: =#
-0.816526*x66-0.204117*x68<=-2,  #= e53: =#
-0.204123*x66-0.8165*x68<=-2,  #= e54: =#
-0.5*x70-0.2*x72<=-2,  #= e55: =#
-0.158113*x70-0.63246*x72<=-2,  #= e56: =#
-0.2*x74-0.2*x76<=-2,  #= e57: =#
-0.1*x74-0.4*x76<=-2,  #= e58: =#
-0.2*x78-0.2*x80<=-2,  #= e59: =#
-0.1*x78-0.4*x80<=-2,  #= e60: =#
x54+0.5*x58<=20,  #= e61: =#
-x54+0.5*x58<=0,  #= e62: =#
x57+0.5*x60<=5,  #= e63: =#
-x57+0.5*x60<=0,  #= e64: =#
