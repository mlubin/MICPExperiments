...
-0.154304*x58-0.462907*x60<=-2,  #= e48: =#
-0.5*x59-0.2*x61<=-2,  #= e49: =#
-0.182575*x59-0.54772*x61<=-2,  #= e50: =#
-0.555556*x62-0.2*x64<=-2,  #= e51: =#
-0.192448*x62-0.577356*x64<=-2,  #= e52: =#
-0.707114*x66-0.2357*x68<=-2,  #= e53: =#
-0.235705*x66-0.7071*x68<=-2,  #= e54: =#
-0.5*x70-0.2*x72<=-2,  #= e55: =#
-0.182575*x70-0.54772*x72<=-2,  #= e56: =#
-0.2*x74-0.2*x76<=-2,  #= e57: =#
-0.115469*x74-0.346412*x76<=-2,  #= e58: =#
-0.2*x78-0.2*x80<=-2,  #= e59: =#
-0.115469*x78-0.346412*x80<=-2,  #= e60: =#
x54+0.5*x58<=20,  #= e61: =#
-x54+0.5*x58<=0,  #= e62: =#
x57+0.5*x60<=5,  #= e63: =#
-x57+0.5*x60<=0,  #= e64: =#
